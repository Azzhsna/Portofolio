        ...
        >
            ...
            <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-24">
                <div className="flex flex-col items-center">
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
                                ...
                                <div className="relative h-full flex flex-col bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-[2rem] overflow-hidden shadow-2xl transition-all duration-500 group-hover:translate-y-[-8px] group-hover:border-amber-500/20 group-hover:shadow-orange-900/20">
                                    ...
                                    <div className="flex-1 p-8 flex flex-col">
                                        ...
                                        <div className="flex items-center gap-3 mb-8 py-3 border-y border-white/5">
                                            ...
                                            <div>
                                                <p className="text-[10px] uppercase tracking-widest text-stone-500 font-bold">{t("certificate.topic")}</p>
                                                <p className="text-stone-300 text-sm font-medium">{cert.topic}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-auto">
                                            {cert.link ? (
                                                ...
                                                >
                                                    ...
                                                    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current group-hover/btn:translate-x-1 transition-transform">
